using Cstj.Sim.Tp2.WBergeronDrouin.Screens;
...
namespace Cstj.Sim.Tp2.WBergeronDrouin
{
    ...
    public class SpaceAttack : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            this.Window.Title = "L'attaque de l'espace";
            // Les updates des deux Services sont exécutés
